...
EOF
LC_ALL=C returns_ 1 sed -f p1 </dev/null 2>err1 || fail=1
...
EOF
LC_ALL=C returns_ 1 sed -f p2 </dev/null 2>err2 || fail=1
...
LC_ALL=en_US.UTF-8 returns_ 1 sed -f p7 </dev/null 2>err7 || fail=1
...
LC_ALL=en_US.UTF-8 returns_ 1 sed -f p8 </dev/null 2>err8 || fail=1
